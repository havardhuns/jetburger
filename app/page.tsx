  ...
  return (
    <div className="flex-1">
      ...
      <section id="hjem" className="relative overflow-hidden">
        ...
        <div className="relative mx-auto flex max-w-[1120px] flex-col items-start justify-center gap-6 px-5 pt-[clamp(72px,12vw,120px)] pb-[clamp(88px,13vw,140px)] md:min-h-0 md:justify-start lg:px-6">
          <FadeUp delay={0.08}>
